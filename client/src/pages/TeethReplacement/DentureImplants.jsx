...
const DentureImplants = () => {
  return (
    <>
      <Banner data={banner_data.dental_implants} />
      {para_data.dental_implants.map((item) => (
      ...
      {faq.dental_implants ? (
        <>
          ...
          {faq.dental_implants?.map((el, index) => (
...
export default DentureImplants;
