export const banner_data = {
  ...
  wisdom_tooth_removal: {
    ...
    banner_extra:
      "If they erupt smoothly and without any interruption, then they can be proved as an asset. But the problem with third molars is that in case they do not erupt properly or are misaligned, they would need to be extracted. If they are poorly aligned, then they can damage the adjacent teeth.",
  },
  jaw_pain_treatment: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
    ...
    banner_extra:
      "We are one of the best dental clinics in Viman Nagar to provide international standard treatment at an affordable price.",
  },
  teeth_replacement: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
    ...
    banner_extra:
      "With the advent of years of refined diet, we have become more susceptible to oral diseases and hence maintaining them has become extremely important. With advancements in dentistry prevention of oral diseases has become easier. Maintenance of oral hygiene has to be practiced from an early age.",
  },
  dentures: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
    ...
    banner_extra:
      "Dentures are of two types – Complete & Partial. Complete dentures are advised when all the teeth are missing, and partial dentures are applied when some natural teeth are missing. They are custom made especially for a set of teeth and gum line.",
  },
  dental_implants: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
  ...
  teeth_whitening: {
    ...
    banner_extra:
      "It is amongst the most common and widely adopted cosmetic procedure. With the advent of the latest Dental technology, we have advanced whitening treatment procedures which give reliable and long-lasting results. For better results do get it done from a trained dental professional.",
  },
  clear_aligners: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
  ...
  teeth_cleaning: {
    ...
    banner_extra:
      "To experience the best teeth cleaning in Viman Nagar, you can visit us at SmyleXL. We are one of the best dental clinics in Viman Nagar with all the latest equipment.",
  },
  mouth_ulcers: {
    banner_image:
      "https://images.unsplash.com/photo-1593642532400-2682810df593?ixlib=rb-1.2.1&ixid=MXwxMjA3fDF8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=750&q=80",
    banner_question: "WHAT IS MOUTH ULCERS?",
    banner_sub_info:
...
export const para_data = {
  rct: [
    {
      para_title: "Root Canal Treatment (RCT)",
      para_info:
    ...
    {
      para_title: "WHY DOES ONE NEED TO UNDERGO ROOT CANAL TREATMENT?",
      para_info:
      ...
      para_list: [
        ...
        "RCT relieves the pain caused due to inflammationne for precise information",
      ],
    },
    {
      para_title: "SYMPTOMS",
    ...
    },
    {
      ...
      para_list: [
        ...
        "The bacteria from infection can enter into the tissues of gum and jaw which can cause a pus-filled abscess. This can even lead to a serious condition likeheart disease and stroke.",
      ],
    },
    {
      para_title: "WHAT IS THE PROCEDURE FOR ROOT CANAL TREATMENT?",
      para_procedure: [
    ...
    {
      para_title: "PRICE OF RCT IN INDIA",
      para_info:
  ...
  wisdom_tooth_removal: [
    {
      para_title: "WHAT PROBLEMS CAN A WISDOM TOOTH CAUSE?",
      para_info:
    ...
    {
      para_title: "SYMPTOMS TO GET WISDOM TEETH REMOVED",
      para_list: [
    ...
    {
      para_title: "SHOULD WISDOM TEETH BE REMOVED?",
      para_info:
    ...
    {
      para_title: "PROCEDURE FOR WISDOM TOOTH EXTRACTION",
      para_info:
    ...
    {
      para_title: "Post Wisdom Tooth Removal",
      para_list: [
        ...
        "TBe on a liquid diet for the first few days. Avoid the use of straw",
        "Do brush twice a day but make sure you are gentle on rinsing",
      ],
    },
    {
      para_title: "PRICE OF TOOTH EXTRACTION",
      para_info:
  ...
  jaw_pain_treatment: [
    {
      para_title: "What is a TMJ disorder? How does it happen?",
      para_info:
        "TMJ (Temporomandibular Joint) disorders are related to your complex jaw joint. TMJ disorders develop for many reasons. It might be due to excessive clenching or grinding of your teeth, tightening your jaw muscles and stressing your TM joint or, a damaged jaw joint due to injury or disease. Whatever the cause, it causes misaligned bite, pain, clicking sound while mouth opening or trouble in opening your mouth wide. Some types of TMJ problems can lead to highly painful conditions if left untreated for a long time. So, it is always suggested that you visit your dentist as soon as you feel any pain or discomfort so that the treatment can be started early and you are completely cured. Nowadays, these problems are much easily diagnosed than it used to be earlier. With the advancements of dentistry, any dental problem has become so easily diagnosable and treatable. You just have to visit your dentist at the earliest and you will be cured.",
    },
    {
      para_title: "What are the treatment options for a TMJ problem?",
      para_info:
        "There are various treatment options that can help to improve the harmony and function of your jaw. It depends on the condition you have. Once you visit us at SmyleXL, our dental surgeons will determine the disorder by a thorough evaluation. Once it is confirmed, our dental surgeons will determine the proper course of treatment. It is important to note that the treatment always works best with a team approach of self-care as well as professional care. So, even after it has been cured, you have to maintain it the way you are instructed. Remember, any dental problem and we are just a call away! Do visit us at SmileXL, one of the best dental clinics in Viman Nagar and give us the opportunity to serve you.",
    },
  ],
  dentures: [
    {
    ...
    {
      para_title: "WHAT IS THE PROCEDURE INVOLVED IN PLACING DENTURES?",
      para_procedure: [
    ...
    {
      para_title: "HOW TO TAKE CARE OF THE DENTURES?",
      para_info:
    ...
    {
      para_title: "DO’S WHILE DENTURES ON",
      para_list: [
    ...
    {
      para_title: "DON’TS WHILE DENTURES ON",
      para_list: [
    ...
    {
      para_title: "MYTHS ABOUT DENTURES",
      para_list: [
    ...
    {
      para_title: "COST OF PARTIAL DENTURES",
      para_info:
  ...
  bridges_crowns: [
    {
      para_title: "WHEN IS DENTAL CROWN NEEDED?",
      para_info:
...
export const faq = {
  rct: [
    {
      question: "Can An Infected Tooth Heal Itself?",
      answer:
        "No, an infected tooth cannot heal itself. In fact, the infection can spread to other areas of your jaw causing serious pain. Treating an infected tooth requires medications or root canal treatment. For getting an RCT, book your appointment at the nearest Smylexl Dental Clinic.",
    },
    {
      question: " Do Root Canals Procedures Hurt A Lot?",
      answer:
    ...
    {
      question: "Can One Get RCT Done In A Day?",
      answer:
  ...
  wisdom_tooth_removal: [
    {
      question: "Do Wisdom Teeth Need To Be Removed?",
      answer:
    ...
    {
      question: "Do They Put You On Anaesthesia For The Procedure?",
      answer:
        "Dentists usually prefer to numb the area before wisdom tooth extraction, and thus recommend a local anaesthesia. If you need to get them removed, consult an expert dentist at your nearest Smylexl Dental clinic.",
    },
    {
      question:
  ...
  dentures: [
    {
      question: "Why Is It Important To Remove Dentures At Night?",
      answer:
    ...
    {
      question: "Can One Sleep With Dentures On?",
      answer:
